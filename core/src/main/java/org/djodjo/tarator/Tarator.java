...
import static org.djodjo.tarator.matcher.ViewMatchers.withClassName;
...
/**
 * Entry point to the Tarator framework. Test authors can initiate testing by using one of the on*
...
public final class Tarator {
   ...
   * an AdapterView (e.g. ListView). If this is the case, use Tarator.onData to load the view
   * first.
   *
