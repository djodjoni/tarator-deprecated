 ...
 */
public class
        TaratorInstrumentationTestRunner
  extends
        TaratorInstrumentation
...
TaratorInstrumentationTestRunner.class.getClassLoader());
   ...
   * TaratorInstrumentation(and TestRunner).
   *
...
super.setInstrumentation(TaratorInstrumentationTestRunner.this);
        }
...
return TaratorInstrumentationTestRunner.this.getTargetContext();
    }

    @Override
    public Context getContext() {
return TaratorInstrumentationTestRunner.this.getContext();
    }

    @Override
    public void start()  {
TaratorInstrumentationTestRunner.this.start();
    }
...
TaratorInstrumentationTestRunner.this.sendStatus(resultCode, results);
    }

    @Override
    public void finish(int resultCode, Bundle results) {
TaratorInstrumentationTestRunner.this.finish(resultCode, results);
    }
  }
