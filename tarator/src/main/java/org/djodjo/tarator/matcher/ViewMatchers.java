...
/**
 * A collection of hamcrest matchers that match {@link android.view.View}s.
 */
public final class ViewMatchers {
 ...
 /**
  ...
  /**
   * Returns a matcher that matches {@link android.view.View}s that are currently displayed on the screen to the
   * user.
   *
  ...
  /**
   * Returns a matcher that matches {@link android.view.View}s that are enabled.
   */
  ...
  /**
   * Returns a matcher that matches {@link android.view.View}s that are focusable.
   */
  ...
  /**
   * Returns a matcher that matches {@link android.view.View}s currently have focus.
   */
  ...
  /**
   * Returns an {@link Matcher} that matches {@link android.view.View}s based on their siblings.<br>
   * <br>
  ...
  /**
   * Returns an {@link Matcher} that matches {@link android.view.View}s based on content description property
  ...
  /**
   * Returns a matcher that matches {@link android.view.View}s based on resource ids. Note: Android resource ids
  ...
  /**
   * Returns a matcher that matches {@link android.view.View} based on tag keys.
   *
   * @param key to match
   */
  ...
  /**
   * Returns a matcher that matches {@link android.view.View}s based on tag keys.
   *
   * @param key to match
  ...
  /**
   * Returns a matcher that matches {@link android.view.View}s based on tag property values.
   *
  ...
  /**
   * Returns a matcher that matches {@link android.widget.TextView} based on it's text property value. Note: View's
  ...
  /**
   * Returns a matcher that matches {@link android.widget.TextView}s based on text property value. Note: View's
  ...
  /**
   * Returns a matcher that matches a descendant of {@link android.widget.TextView} that is displaying the string
  ...
  /**
   * Returns an {@link Matcher} that matches {@link android.view.View}s with any content description.
   */
  ...
  /**
   * Returns a matcher that matches {@link android.view.View}s based on the presence of a descendant in its view
   * hierarchy.
   *
  ...
  /**
   * Returns a matcher that matches {@link android.view.View}s that are clickable.
   */
  ...
  /**
   * Returns a matcher that matches {@link android.view.View}s based on the given ancestor type.
   *
  ...
  /**
   * Returns a matcher that matches {@link android.view.View}s that have "effective" visibility set to the given
  ...
  /**
   * Returns a matcher that matches root {@link android.view.View}.
   */
   ...
   * specified IME action set in its {@link android.view.inputmethod.EditorInfo}.
   *
